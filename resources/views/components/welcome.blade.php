...
<head>
    ...
    <style>
        ...
        .password-container {
            position: relative; /* This is key for positioning the icon */
                            ...
                            <div id="users-form" class="form-section active">
                                <form class="space-y-6" method="POST" action="{{ route('add.user') }}">
                                    ...
                                    <div>
                                        ...
                                        <input type="email" id="user-email" name="user_email" value="{{old('user-email')}}"  required class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm py-2 px-3 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm">
                                    </div>

                                    <div>
                                        <label for="user-phone" class="block text-sm font-medium text-gray-700">User Phone <span class="text-red-500">*</span></label>
                                        <input type="number" id="user-phone" name="user_phone" value="{{old('user-phone')}}" required class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm py-2 px-3 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm">
                                    </div>
                                    ...
                                    <div class="password-container">
                                        ...
                                        <input type="password" id="user-password" name="user_password" required class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm py-2 px-3 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm">
                                        <i class="fa-solid fa-eye-slash" id="togglePassword"></i>
                                    </div>

                                    <div class="password-container">
                                        <label for="user-password-confirmed" class="block text-sm font-medium text-gray-700">Confirm User Password <span class="text-red-500">*</span></label>
                                        <input type="password" id="user-password" name="user_password_confirmation" required class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm py-2 px-3 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm">
                                        <i class="fa-solid fa-eye-slash" id="togglePassword"></i>
                                    </div>
                                    
                                    <div>
                                        <label for="user-role" class="block text-sm font-medium text-gray-700">User Role <span class="text-red-500">*</span></label>
                                        <select id="user-role" name="user_role" required class="mt-1 block w-full bg-white border border-gray-300 rounded-md shadow-sm py-2 px-3 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm">
